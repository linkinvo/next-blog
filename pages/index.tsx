  ...
  return (
    <div className="min-h-screen bg-gray-200 antialiased xl:flex xl:flex-col xl:h-screen">
      ...
      <div className='xl:flex-1 xl:flex xl:overflow-y-hidden'>
        <SearchFilters />
        <main className='mt-6 sm:overflow-x-auto sm:overflow-y-hidden'>
...
const Card = (props: CardProps) => {
  ...
  const { baths, beds, image, description, price, reviews, currency } = property;
  return (
    <div className='mt-10 sm:mt-0 sm:max-w-xs sm:w-full sm:flex-shrink-0 sm:px-2'>
      <div className='relative pb-5/6'>
        <img className='absolute insert-0 h-full rounded-lg shadow-md object-cover' src={image} alt="modern-home" />
      </div>
